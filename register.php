					...
					if(isset($_POST['btnsubmit']))
					{
						...
						$Rpassword=$_POST['confirmpassword'];
							...
							else
							{
									...
									$check_mobile_query = "SELECT * FROM tblbuyer WHERE mobileno='$mobile'";

									$result = mysqli_query($con, $check_mobile_query);
        
									if(mysqli_num_rows($result) > 0) 
		
									{
           
										echo "<p style=\"color:red\">Your account already exists. Please log in instead.</p>";
									}
