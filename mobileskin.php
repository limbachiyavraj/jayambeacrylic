...
include('dbcon.php');
		...
		
	{
		...
		while ($line = mysqli_fetch_array($result)) {
			...
			echo "<div class=\"card\" style=\"height:1000px;width:300px;\">";
			echo "<div class=\"product-item bg-light\">";
			echo "<div class=\"product-img position-relative overflow-hidden\">";
			echo "<a href=\"mobileview.php?id=$id\"><img src=\"$photo\" class=\"card-img-top\"  style=\"height:300px;width:298px;border:1px solid red\" alt=\"...\"></a>";
			echo "</div></div>";
			...
			echo "<a href=\"cart.php?id=$id\" class=\"btn btn-primary py-2 px-lg-2 d-none d-lg-block\">View Product<i class=\"fa fa-arrow-right ms-3\"></i></a>";
		...
		
	{
		...
		while ($line = mysqli_fetch_array($result)) {
			...
			echo "<a href=\"mobileview.php?id=$id\" class=\"btn btn-primary py-2 px-lg-2 d-none d-lg-block\">Add To Cart<i class=\"fa fa-arrow-right ms-3\"></i></a>";
...

	{
		...
		while ($line = mysqli_fetch_array($result)) {
			...
			echo "<div class=\"product-item bg-light\">";
			echo "<div class=\"product-img position-relative overflow-hidden\">";
			echo "<a href=\"tshirtview.php?id=$id\"><img src=\"$photo\" class=\"card-img-top\"  style=\"height:300px;width:298px;border:1px solid red\" alt=\"...\"></a>";
			echo "</div></div>";
			echo "<div class=\"card-body\">";
			echo "<h5 class=\"card-title\">Product Name: $name</h5>";
			echo "<h5>Price: $price/-</h5>";
			...
			echo "<a href=\"tshirtview.php?id=$id\" class=\"btn btn-primary py-2 px-lg-2 d-none d-lg-block\">View Product<i class=\"fa fa-arrow-right ms-3\"></i></a>";
