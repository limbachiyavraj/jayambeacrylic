		...
		while($line=mysqli_fetch_array($result))
			{
				...
				echo "<tr><td><button href=\"practice2.php\" name=\"btnorder\" id=\"btnorder\"  class=\"btn btn-block  btn-primary font-weight-bold my-6 py-6  type=\"submit\">Place Order</button></td></tr>";
